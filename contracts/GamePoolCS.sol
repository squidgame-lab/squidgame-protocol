...
contract GamePoolCS is Configable, Pausable, ReentrancyGuard, Initializable {
    ...
    function configure(address _buyToken, address _shareToken, uint64 _epoch, uint64 _shareReleaseEpoch, bool _enableRoundOrder) external onlyDev {
        buyToken = _buyToken;
